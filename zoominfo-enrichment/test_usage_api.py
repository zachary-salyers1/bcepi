...
# Try Usage API as a health check
URL = "https://api.zoominfo.com/lookup/usage" # Common usage endpoint, trying lookup/usage

def test_usage():
    print("Testing Usage API with Manual Token...")
